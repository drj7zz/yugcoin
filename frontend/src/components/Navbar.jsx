...
function BrandMark() {
  return (
    <div className="navbar-brand flex items-center" style={{ cursor: 'pointer', background: 'transparent', border: 'none' }} onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
      <span className="navbar-brand-text">YugCoin</span>
    </div>
  );
}
